...
El script en lenguaje Python y utilizando la librería PILLOW aplica una serie de efectos modificadores en una imagen cargada previamente. Dichos efectos son: *Escala de grises*, *Brillo*, *Contraste*, *desenfoque gaussiano*, y una combinación entre escala de grises y contraste.
  ...
  * **Brillo:**
    Una vez cargada la imagen la clase 'Tonalidad' aplica el método 'brillo' que aplica el efecto transformando la imagen (mediante un factor numérico)        agregandole luz mediante valores mayores a 1 y los valores que son menores a 1 disminuyen. Este método llama a Pillow para que se encargue mediante el módulo ImageEnhance con la clase Brightness utilicen el método enhance para aplicar el factor numérico de luz.

  * **Contraste:**
    Una vez cargada la imagen la clase 'Tonalidad' aplica el método 'contraste' con los mismos parámetros que el brillo.
...
## Salir
 ...
 - Mediante la selección de la última opción del menú, el programa finaliza.

  <img width="626" height="330" alt="salir" src="https://github.com/user-attachments/assets/9bc7a487-509d-47ca-9bff-370eda01be31" />

## Decisiones importantes:
  - Se tomó la decisión de realizar un menú interactivo para agregarle funcionalidad al programa y testearlo de forma segura con posibilidad de mejorarlo a futuro
